...
# full byte-exact Snell v6 shaping). See PROTOCOL.md.
...
SRC = proxy.c snell_tunnel.c snell_shape.c inter_pad_len.c snell_salt_prng.c snell_crypto.c
HDR = snell_tunnel.h snell_shape.h snell_crypto.h
